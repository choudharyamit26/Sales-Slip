# Generated by Django 3.1.3 on 2021-02-02 05:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('branch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='src.branch')),
        ...
        migrations.AddField(
            model_name='branch',
            name='merchant_name',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='src.merchant'),
        ),
    ]
