...
urlpatterns = [
    ...
    path('change-language/<int:pk>/',
         ChangeLanguageApiView.as_view(), name='change-language'),
    path('change-notification/<int:pk>/',
         ChangeNotificationApiView.as_view(), name='change-notification'),
